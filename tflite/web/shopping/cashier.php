                    ...
                    <span class="navbar-toggler-icon"></span>
                     ...
                     <div class="collapse navbar-collapse" id="navbarSupportedContent">
                       ...
                       <ul class="navbar-nav mr-auto">
                         <li class="nav-item">
                            <p class="nav-link title_logo">Inventory System - Cashier</p>
                         </li>
                       </ul>
...
<?php require_once 'cashierprocess.php'; ?>
...
?>
    ...
    <form class="from1"action ="cashier.php" method ="POST">  
